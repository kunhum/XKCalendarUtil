...
{
    float y1        = (100*g / 100 + 147.8) / 36524.25;
    NSString *yStr  = [NSString stringWithFormat:@"%f",y1*100];
    NSString *yStr1 = [yStr substringToIndex:4];
//    (10000 * g + 14780) / 3652425
    long y = yStr1.intValue;
